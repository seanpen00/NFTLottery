        ...
        return (
            <div className='footer-control' id="socials">
                <Container className='footer'>
                    <p><a target="_blank" rel="noopener noreferrer" href="https://metaversesolutions.ai/" style={{ textDecoration: "none", color: "purple", textAlign: "left" }}> <text className="banditz">© 2022 The NFT Lottery. All Rights Reserved</text>
                    </a></p>
                    <div>
                       ...
                       <a style={{textDecoration: "none", color:"white"}}target="_blank" rel="noopener noreferrer"href="https://discord.com/"> <BsDiscord size={32} />   </a>      */}
                        ...
                        <p><a target="_blank" rel="noopener noreferrer" href="https://metaversesolutions.ai" style={{ textDecoration: "none", color: "purple", textAlign: "right" }}><text className="metaverse">Metaverse Solutions, LLC</text></a></p>
